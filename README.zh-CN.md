...
| 平台 | 文件名 | 大小 | 说明 |
|------|--------|------|------|
| **Windows** | [SerialWebViewer.exe](https://github.com/forqzy/SerialWebViewer/releases/download/v1.0.0/SerialWebViewer.exe) | ~5 MB | Windows可执行文件 |
| **Linux** | [serialwebviewer](https://github.com/forqzy/SerialWebViewer/releases/download/v1.0.0/serialwebviewer) | ~5 MB | Linux二进制文件 |
| **macOS (Intel)** | [SerialWebViewer.mac](https://github.com/forqzy/SerialWebViewer/releases/download/v1.0.0/SerialWebViewer.mac) | ~5.5 MB | macOS Intel版本 |
| **macOS (ARM64)** | [SerialWebViewer-arm64.mac](https://github.com/forqzy/SerialWebViewer/releases/download/v1.0.0/SerialWebViewer-arm64.mac) | ~5.3 MB | macOS ARM64版本 |

### 下载后快速开始

**Windows：**
1. 下载 `SerialWebViewer.exe`
2. 双击运行
